                        ...
                        <div id="content-panel" style="clear: both">
                            <div class="ui-widget-content" style="padding:10px;">
                                ...
                                if (isset($nodeList) && !empty($nodeList) && is_array($nodeList)) {
                                    $activeNodeID = $this->get('topics.id');
                                ...
                                ?>
                                <div> 
                                    <a href="<?php echo ($prev != false ? $this->request->module . "/" . $this->request->controller . '/__view' . '?id=' . $prev : "#"); ?>"> Previous </a> 
                                    | 
                                    <a  href="<?php echo ($prev != false ? $this->request->module . "/" . $this->request->controller . '/__view' . '?id=' . $prev : "#"); ?>">Next</a>
                                </div>
