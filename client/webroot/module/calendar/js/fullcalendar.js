...
(function($, undefined) {
    ...
    function Header(calendar, options) {
        ...
        function render() {
            ...
            if (sections) {
                element = $("<table  class='fc-header ui-bar-c' style='width:100%'/>")
                .append(
                    $("<tr/>")
                    ...
                    $.each(this.split(','), function(j, buttonName) {
                        if (buttonName == 'title') {
                            ...
                            if (buttonClick) {
                                ...
                                switch(buttonName){
                                    case 'prev':
                                        mobileClass='ui-icon-arrow-l ui-icon-shadow ';
                                        break;
                                    case 'next':
                                        mobileClass='ui-icon-arrow-r ui-icon-shadow ';
                                        break;
                                ...
                                var button = $(
                                    ...
                                    (icon ?
                                        ...
                                        "<span class='ui-icon "+mobileClass+" ui-icon-" + icon + "'/>" +
                                        "</span>" :
                                        text
                                        ) +
                                    "</span>" +
...
*/
	...
	----------------------------------------------------------------------------*/
        ...
        function slotSegHtml(event, seg) {
            ...
            var hashColor='#'+jQuery.md5((typeof event.color_code != 'undefined'?event.color_code:1)).substr(0, 6);
            skinCss += ';background-color:'+hashColor+';border-color:'+hashColor+';';
