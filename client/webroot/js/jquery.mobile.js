...
$.widget( "mobile.listview", $.mobile.widget, {
	...
	_createSubPages: function() {
		...
		$( parentList.find( "li>ul, li>ol" ).toArray().reverse() ).each(function( i ) {
			...
			hasSubPages = true;
                        /**
                         * Add back button to nested listviews.
                         *@author: tushar takkar
                         *@date: 2012-09-07
                         */
			newPage = list.detach()
						.wrap( "<div data-add-back-btn='true' " + dns + "role='page' " + dns + "url='" + id + "' " + dns + "theme='" + theme + "' " + dns + "count-theme='" + countTheme + "'><div " + dns + "role='content'></div></div>" )
						.parent()
