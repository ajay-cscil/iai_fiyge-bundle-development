		...
		if (this.tooltip.is(':animated'))
				this.tooltip.stop().fadeTo("normal", 0, function() {
					$(this).hide().css("opacity", "");
                           ...
                           var fadeOut=typeof CONFIG !==undefined && typeof CONFIG.tooltip_fadeout_duration!= undefined?CONFIG.tooltip_fadeout_duration:0;
				if(fadeOut=== undefined)
                                    fadeOut=0;
                                this.tooltip.stop().delay(fadeOut).fadeOut();
                        }
