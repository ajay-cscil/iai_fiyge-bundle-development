...
<div id="tabcontent-upload-image" class="tabcontent">
	...
	<div class="button-container">
		...
		<button type="button" id="copy-image" class="btn btn-success pull-right">Done</button>
	</div>
</div>
<div id="tabcontent-draw-image" class="tabcontent">
  	...
  	<div class="button-container">
		...
		<button type="button" id="copy-drawpad" class="btn btn-success pull-right">Done</button>
  	</div>
</div>
