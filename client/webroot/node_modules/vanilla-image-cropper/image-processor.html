...
<div id="tabcontent-upload-image" class="tabcontent">
	...
	<div class="button-container">
		<button type="button" id="upload-image" class="btn btn-primary">Upload Image</button>
		<button type="button" id="clear-image" class="btn btn-default">Clear</button>
		<button type="button" id="copy-image" class="btn btn-success pull-right">Copy Selected</button>
	</div>
</div>
<div id="tabcontent-draw-image" class="tabcontent">
  	...
  	<div class="button-container">
		...
		<button type="button" id="copy-drawpad" class="btn btn-success pull-right">Copy Selected</button>
  	</div>
</div>
