	    		...
	    		if(options.formData){
			    	...
			    	var formBuilderOptions={
				        ...
				        "onAddField": function(fieldId,field) {
						    ...
						    if(field.name && options.controller){
						    	var controller=options.controller.split('/')[1];
						    		if(field.type && field.type =="button"){
						    			field.name="data["+controller+"][action]";
						    		}else if(field.name.indexOf("data["+controller+"][") == -1){
						    			field.name="data["+controller+"][field_name]";
						    		}
